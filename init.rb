...
Redmine::Plugin.register :redmine_git_hosting do
	...
	settings :default => {
		...
		'gitRepositoryBasePath' => 'repositories/',
    		...
    		'gitLockWaitTime' => '10',
		'gitoliteIdentityFile' => Rails.root + '/.ssh/redmine_rsa',
		'gitoliteIdentityPublicKeyFile' => Rails.root + '/.ssh/redmine.pub',
		'allProjectsUseGit' => 'true',
    		'gitDaemonDefault' => '0',   # Default is Daemon enabled
		'gitHttpDefault' => '0',     # Default is HTTP_ONLY
   		'gitNotifyCIADefault' => '1', # Default is CIA Notification disabled
		'deleteGitRepositories' => 'false',
		'gitRepositoriesShowUrl' => 'true',
		'gitCacheMaxTime' => '-1',
		'gitCacheMaxElements' => '1000',
		'gitCacheMaxSize' => '16',
		'gitHooksDebug' => 'true',
		'gitHooksAreAsynchronous' => 'true',
    		'gitTempDataDir' => '/tmp/redmine_git_hosting/',
		'gitScriptDir' => '/plugins/redmine_git_hosting/bin/',
